...
export const GREEN_SECTION = [
    ...
    },
    {
        ...
        description: "Smart systems reducing energy consumption",
        icon: icon2,
        bg: "bg-[#3B82F6]",
    ...
    },
    {
        ...
        description: "Purification and conservation technologies",
        icon: icon3,
        bg: "bg-[#06B6D4]",
    ...
    },
    {
        ...
        description: "CO2 removal and storage technologies",
        icon: icon6,
        bg: "bg-[#6B7280]", 
    },
]
